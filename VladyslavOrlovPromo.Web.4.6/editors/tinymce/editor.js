...
tinymce.init({
    ...
    toolbar: "styleselect | bold underline italic | alignleft aligncenter alignright | bullist numlist | forecolor backcolor | link image media sh4tinymce | fullscreen code | filemanager",
